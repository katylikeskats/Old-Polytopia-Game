    ...
    private void assignCapitals() {
      ...
      if (numPlayers == 2) {
        for (int i = 0; i < 2; i++) {
          ...
          System.out.println("Capital city of player " + i + " is at " + bestCity.getC() + ", " + bestCity.getR() + " and the tribe is " + bestCity.getTribe()); //For checking capital city determination
        }
