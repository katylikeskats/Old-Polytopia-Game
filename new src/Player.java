...
public class Player {
	...
	private boolean inGameBonus = 0; //The bonus currency increase from ports
	...
	* @param A city object being added to the list
	* @return nothing
	*/
	...
	* @param An integer to represent the bonus being set
	*/
